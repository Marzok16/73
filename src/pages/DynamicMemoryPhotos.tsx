...
// Special photos that are always shown
const specialPhotos = [
  {
    id: 'tower',
    image: towerImage,
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(`${API_BASE}/memory-categories/with_photos/`);
      ...
      <div>
        ...
        <div className="pt-16 min-h-screen flex items-center justify-center bg-gray-50">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold mb-2">جاري تحميل الصور التذكارية</h2>
      ...
      <div className="pt-16">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
            {/* Special Sections - Only show when not filtering */}
            {!searchTerm && selectedCategory === "all" && (
              <div className="grid md:grid-cols-2 gap-8 mb-16">
                {specialPhotos.map((photo) => (
                  <div key={photo.id}>
                    ...
                    <Card 
                      className="overflow-hidden shadow-warm hover:shadow-card transition-all duration-300 cursor-pointer"
                    ...
                    >
                      <div className="relative h-96 overflow-hidden bg-muted/10">
                        ...
                        <div className="absolute bottom-4 left-4 right-4">
                          <h3 className="text-white text-lg font-bold mb-2">{photo.title}</h3>
                ...
                {selectedCategory === "all" ? (
                  <div className="text-center mb-16 px-4">
                    <div className="relative py-12">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-r from-primary/10 via-blue-600/10 to-purple-600/10 blur-2xl opacity-60 rounded-2xl"></div>
                      
                      <div className="relative z-10">
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-primary animate-fade-in leading-normal tracking-wide">
                          مجموعة الذكريات الجامعية
                        </h2>
                        
                        {/* Gradient underline */}
                        <div className="w-32 h-1.5 bg-gradient-to-r from-primary via-blue-600 to-purple-600 mx-auto rounded-full shadow-lg"></div>
            ...
            {categories.length === 0 && (
              <div className="text-center py-16">
                ...
                <h3 className="text-2xl font-bold mb-2">لا توجد صور متاحة</h3>
                <p className="text-muted-foreground">
                  لم يتم رفع أي صور تذكارية بعد. تواصل مع إدارة الموقع لإضافة المحتوى.
                </p>
              </div>
            )}
...
export default DynamicMemoryPhotos;